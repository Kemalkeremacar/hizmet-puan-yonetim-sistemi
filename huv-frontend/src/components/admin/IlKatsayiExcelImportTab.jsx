// ============================================
// İL KATSAYILARI EXCEL IMPORT TAB
// ============================================
// İl katsayıları için Excel import arayüzü
// ============================================
...
export default function IlKatsayiExcelImportTab() {
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      const response = await adminService.previewIlKatsayiImport(formData);
        ...
        <Box sx={{ p: 3, bgcolor: 'info.light' }}>
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <Typography variant="h6" fontWeight="600">
              İl Katsayıları Excel Dosyası Yükle
            </Typography>
          </Stack>
        </Box>
        <Divider />
        <Box sx={{ p: 3 }}>
          <Alert severity="info" sx={{ mb: 3 }}>
            ...
            <Typography variant="caption" display="block" sx={{ mt: 1 }}>
              • Önizleme ile hangi il katsayılarının ekleneceğini, güncelleneceğini veya silineceğini görebilirsiniz<br />
              • Import geçmişini ve detaylı raporları "Versiyon Geçmişi" sekmesinden görüntüleyebilirsiniz<br />
              • Dönem bilgisi Excel başlığından otomatik çıkarılır
            </Typography>
          </Alert>
          ...
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} alignItems="center">
            <Box sx={{ flex: 1, width: '100%' }}>
              <TextField
                id="il-katsayi-excel-file-input"
                type="file"
                fullWidth
